...
CREATE TABLE `ativos` (
  ...
  `status` enum('DISPONIVEL','ALOCADO','DEFEITO') NOT NULL,
  `CGR` varchar(10) NOT NULL,
...
INSERT INTO `ativos` VALUES ('Computador para casa','ALOCADO','343434','Notebook','Dell'),('Monitor LG','DISPONIVEL','775502','Monitor','LG');
